...
| ------------------------------------------------------------------- | -------------------------------- |
| `idd-skill` in repo-name contexts                                   | `kurone-kito/oneiron`                  |
| `idd-skill` in marker-prefix contexts (e.g. `idd-skill-roadmap-id`) | `oneiron`      |
| **fix-validate** command string                                     | `pnpm run lint:fix`      |
| **pre-push-validate** command string                                | `pnpm run lint` |
| **post-fix-validate** command string                                | `pnpm run lint` |
