...
| -------------------------------- | --------------------------------------------------------- | ---------------------------------- |
| `kurone-kito/oneiron`                  | Repository short name used in worktree examples           | `my-app`                           |
| `oneiron`      | Hidden issue-body marker prefix                           | `my-app`                           |
...
`oneiron` appears in two hidden issue-body markers:

- roadmap identity marker:
  `<!-- oneiron-roadmap-id: {unique-id} -->`
- blocked-by marker:
